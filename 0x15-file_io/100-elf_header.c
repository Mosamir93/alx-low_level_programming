 ...
 * @e_ident: A pointer to ELF version array.
 */
void print_osabi(unsigned char *e_ident)
{
	printf(" OS/ABI: ");
 ...
 * @e_ident: A pointer to ELF magic numbers array
 */
void print_magic(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: A pointer to ELF ABI version array
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * check_elf - Checks wheter the file is an ELF file
 * @e_ident: A pointer to ELF magic numbers array
 */
void check_elf(unsigned char *e_ident)
{
